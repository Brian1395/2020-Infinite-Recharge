...
if __name__ == "__main__":
    ...
    outputStream = camServer.putVideo("stream", (image_width), (image_height))
    
    # loop forever
    while True:
        timestamp, img = cvSink.grabFrame(img)
        frame = img.copy()
        blobs, conts = GripPipeline().process(frame)
        #print(blobs)
        ...
        for i in conts:
            ...
            if(M["m00"] != 0):
                ...
                cv2.circle(img,(x,y),rad,(199,190,24),3)
                #cv2.putText(img,str(num),(x-5,y+12),cv2.FONT_HERSHEY_SIMPLEX, .8, (255,255,255),3)
                
            else:
                print("POWER CELL NOT FOUND")
                sd.putNumberArray("X-Centers",[0])
                sd.putNumberArray("Y-Centers",[-1])
                sd.putNumberArray("ContourAreas",[0])
            
                
        sd.putNumberArray("X-Centers",XConts)
        sd.putNumberArray("Y-Centers",YConts)
        ...
        if(xTrack != 10 and len(XConts) > 0):  
            ...
            cv2.circle(img,(int((XConts[temp]*80)+80),int((YConts[temp]*-60)+60)),3,(0,0,0),5)#(3,252,123)
            #cv2.circle(img,(int((XConts[temp]*80)+80),int((YConts[temp]*-60)+60)),3,(0,0,0),1)
            #cv2.putText(img,str(len(XConts)),(80,60),cv2.FONT_HERSHEY_SIMPLEX, .8, (255,255,255),3)
...
##            cy = (y - 60)/-60
##            
##            sd.putNumber("X-Center",cx)
##            sd.putNumber("Y-Center",cy)
##
##            cv2.circle(img,(x,y),10,(199,190,24),3)
##        else:
##            print("POWER CELL NOT FOUND")
##            sd.putNumber("TEST",0)
